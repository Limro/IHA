...
Systemet er opbygget på STK-500 boarded, hvorpå der er tilkoblet forskellige elementer:
	...
	\begin{itemize}
	\item Et LM75 print
	\item Et Demo Board med et LCD162 påbygget.
...
Softwaren er, som nævnt tidligere i afsnittet, skrevet oven på Free RTOS i {\code{C}}.
...
\\
\\
Trådene og deres interaktion ses på figur \ref{fig:two-tasks}
