...
\subsection{Drivers}
Til projektet er der blevet brugt nogle drivere fra opgaverne fra AMS-forløbet, samt udleverede drivere til UART'en og LED'erne.
...
Listing \ref{LCDInt} virker således, at den tager imod den ønskede \code{int}, som overføres til et array med plads til 3 \code{chars}\footnote{Her burde være 6 pladser, så der er plads til -32768 og op til +32767}, hvorefter \code{itoa}-funktionen skriver dataen ind i arrayet i decimal format.
