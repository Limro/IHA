...
add wave -noupdate -radix decimal /playsoundandram_tb/data1
add wave -noupdate -radix decimal /playsoundandram_tb/data2
...
add wave -noupdate -radix decimal /playsoundandram_tb/PS/read_count
add wave -noupdate -radix decimal /playsoundandram_tb/PS/cs1
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1079000 ps} 0}
