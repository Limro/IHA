...
# ACDS 12.1 177 win32 2013.02.22.12:52:53
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  ncvlog      "c:/altera/12.1/quartus/eda/sim_lib/cycloneii_atoms.v"                -work cycloneii_ver   
  ...
  ncvhdl -v93 "c:/altera/12.1/quartus/eda/sim_lib/cycloneii_atoms.vhd"              -work cycloneii       
  ncvhdl -v93 "c:/altera/12.1/quartus/eda/sim_lib/cycloneii_components.vhd"         -work cycloneii       
fi
