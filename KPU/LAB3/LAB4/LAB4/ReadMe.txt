========================================================================
    ACTIVE TEMPLATE LIBRARY : LAB4 Project Overview
========================================================================

AppWizard has created this LAB4 project for you to use as the starting point for
...
LAB4.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (LAB4.h)
        GUID definitions                                (LAB4_i.c)
        A type library                                  (LAB4.tlb)
        Marshaling code                                 (LAB4_p.c and dlldata.c)

LAB4.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in LAB4.idl. It will be regenerated by MIDL during compilation.
...
LAB4ps.vcxproj
	...
	dlldata.c, LAB4_i.c and LAB4_p.c which are required
	to build the proxy/stub DLL.

LAB4ps.vcxproj.filters
