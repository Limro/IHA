...
#define nstates2	14	/* ltl_0 */
#define minseq2	73
#define maxseq2	85
#define endstate2	13

#define nstates1	7	/* :init: */
#define minseq1	67
#define maxseq1	72
#define endstate1	6

#define nstates0	68	/* P */
#define minseq0	0
#define maxseq0	66
#define endstate0	67
...
#define Air0	(sizeof(P0) - Offsetof(P0, pidx) - 1*sizeof(uchar))
...
#define Addproc(x)	addproc(256, 1, x, 0)
#define LOCAL	1
#define Q_FULL_F	2
#define Q_EMPT_F	3
#define Q_EMPT_T	4
